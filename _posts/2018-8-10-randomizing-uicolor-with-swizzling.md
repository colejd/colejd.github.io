...
{%- include widgets/lazy-load-image.html image_path='/assets/posts/randomizing-uicolor-with-swizzling/stage1.png' alt_text='Slide looking perfectly normal.' style='max-height: 75vh;' -%}
...
{%- include widgets/lazy-load-image.html image_path='/assets/posts/randomizing-uicolor-with-swizzling/stage2.png' alt_text='Slide with mostly randomized colors.' style='max-height: 75vh;' -%}
...
{%- include widgets/lazy-load-image.html image_path='/assets/posts/randomizing-uicolor-with-swizzling/stage3.png' alt_text='Slide with fully randomized colors.' style='max-height: 75vh;' -%}

Note how everything is affected, including the individual drawable elements in the status bar:

{%- include widgets/lazy-load-image.html image_path='/assets/posts/randomizing-uicolor-with-swizzling/stage3-toolbar.png' alt_text='A close-up of the system toolbar with mostly randomized colors.' style='max-height: 75vh;' -%}
